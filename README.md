...
### Making Commits with Claude Code

We use Claude Code's `/commit` command for clean, conventional commit messages:
...
# 2. Suggest a commit message (type, scope, description)
# 3. Ask for approval
